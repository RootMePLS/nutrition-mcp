...
| `log_supplement_intake`            | Append an immutable intake fact (direct id, unique alias, or active regimen; servings, time, done/missed/cleared); done facts snapshot the bound label version; caloric meal linkage arrives with the sports-snack slice                                                                                                             |
