...
export async function listSupplementRegimens(
    pool: Queryable,
    userId: string,
    options: { includeInactive?: boolean; productId?: string; limit?: number } = {},
...
const SUPPLEMENT_REGIMEN_OUTPUT_SCHEMA = { /* mirrors SupplementRegimenReadback */ };
const SUPPLEMENT_INTAKE_FACT_OUTPUT_SCHEMA = { /* mirrors SupplementIntakeFactReadback; visible_state: z.enum(["undefined","done","missed"]) */ };
...
const REGIMEN_STATUS_OUTPUT_SCHEMA = { /* regimen + occurrences[] with visible_state enum */ };
```
